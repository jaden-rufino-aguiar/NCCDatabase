          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">Cadet Details</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">Manage Details</h3>
  ...
  $query = mysqli_query($con, "SELECT * FROM students");
                      ...
                      while($row=mysqli_fetch_array($query))
                      {
                        ...
                        <tr>
                          ...
                          <td class="align-middle"><a href="#"><img src="studentimages/<?php echo htmlentities($row['studentImage']);?>" width="43" height="53"> </a></td>
...
<button class="big-button" onclick="location.href='xl.php'">More Options</button>
