...
if (strlen($_SESSION['sid']==0)) {
  ...
  if(isset($_POST['submit']))
  {
    ...
    $sql="update tblusers set name=:name,username=:username,mobile = CASE WHEN :mobile <> '' THEN :mobile ELSE NULL END, email=:email,lastname=:lastname where id=:eid";
                    ...
                    <div class="col-md-8">
                      <div class="p-3 py-5">
                        ...
                        <div class="row mt-2">
                          ...
                          <div class="col-md-6"><input type="text" class="form-control" value="<?php echo $row->lastname; ?> " name="lastname" ></div>
                        </div>
                        <div class="row mt-3">
                          <div class="col-md-6"><input type="text" class="form-control" name="email" value="<?php  echo $row->email;?>" required></div>
                          <div class="col-md-6"><input type="text" class="form-control" value="0<?php echo $row->mobile; ?>" name="mobile" ></div>
                        </div>
                        <div class="row mt-3">
                          <div class="col-md-6">
